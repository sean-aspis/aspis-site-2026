...
/**
 * The legal document template, shared by /legal/[slug] and /privacy-policy.
 * Content lives in data/legal.ts, including the sourcing rules that govern
 * what may be asserted in it.
 *
 * Measure is capped at ~72 characters. These are long documents read in one
